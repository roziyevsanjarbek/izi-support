                            ...
                            <form method="POST" action="{{ route('login.post') }}">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div x-data="{ checked: false }" class="flex items-center justify-between">
                                        <label
                                            class="flex cursor-pointer items-center text-sm font-normal text-gray-700 dark:text-gray-400">

                                            <input type="checkbox" name="remember" value="1" class="sr-only"
                                                x-model="checked" />

                                            <div :class="checked ? 'border-brand-500 bg-brand-500' : 'border-gray-300 dark:border-gray-700'"
    ...
    <div class="z-1 flex items-center justify-center">
        ...
        <div class="flex max-w-xs flex-col items-center">
            <a href="/" class="mb-4 flex items-center justify-center">
                <span class="flex h-12 w-12 items-center justify-center rounded-xl bg-brand-500 text-white font-bold text-xs shadow-sm">
                    IZI
                </span>
            </a>
