...
<aside id="sidebar"
    class="fixed flex z-40 flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out z-9999 border-r border-gray-200"
    {{-- class="fixed flex z-40 flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 text-gray-900 h-screen transition-all duration-300 ease-in-out border-r border-gray-200" --}}
    x-data="{
        openSubmenus: {},
        init() {
    ...
    @mouseenter="if ($store.sidebar.hoverEnabled && !$store.sidebar.isExpanded) $store.sidebar.setHovered(true)"
@mouseleave="if ($store.sidebar.hoverEnabled) $store.sidebar.setHovered(false)"
    <!-- Logo Section -->
    ...
    <a href="/dashboard" class="flex items-center gap-2">
        ...
        <div
            ...
            class="flex items-center gap-2 font-bold text-lg text-gray-900 dark:text-white"
        >
            <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-500 text-white font-bold text-xs shadow-sm">
                IZI
            </span>

            <span>IziSupport</span>
        </div>

        <!-- COLLAPSED STATE -->
        <span
            x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
            class="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-500 text-white font-bold text-xs shadow-sm"
        >
            IZI
        </span>
