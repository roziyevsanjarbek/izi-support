<header
    ...
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <!-- Logo (mobile only) -->
            <a href="/dashboard" class="xl:hidden flex items-center gap-2 font-bold text-xl text-gray-900 dark:text-white">
    <span class="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-500 text-white font-bold">
        IZI
    </span>
