...
<div>
    ...
    <!-- Modal -->
    <div class="fixed inset-0 items-center justify-center hidden p-5  modal z-99999" id="eventModal">
        <div class="modal-close-btn fixed inset-0 h-full w-full bg-gray-400/50 backdrop-blur-[32px]"></div>
        <div class="modal-dialog relative flex w-full max-w-[700px] flex-col  rounded-3xl bg-white p-6 lg:p-11 dark:bg-gray-900">
            ...
            <div class="flex flex-col px-2  modal-content custom-scrollbar">
